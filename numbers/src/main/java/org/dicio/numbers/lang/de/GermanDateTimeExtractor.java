...
public class GermanDateTimeExtractor {
    ...
    GermanDateTimeExtractor(final TokenStream tokenStream,
        ...
        this.now = now;
        this.numberExtractor = new GermanNumberExtractor(ts, shortScale);
